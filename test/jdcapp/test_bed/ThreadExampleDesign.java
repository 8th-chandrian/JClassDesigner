 ...
 * @author Noah
 */
public class ThreadExampleDesign {
    
    private DataManager testData;
    private static final String filePath = "./work/DesignSaveTest.";
    
    public ThreadExampleDesign(){
        ...
        ArrayList<String> counterTaskExampleImplementedClasses = new ArrayList<>();
